...
#
#  Step 3 — POTFILES.in regeneration
#    Rewrites po/POTFILES.in from the discovered file list.
#    Do not edit this file manually — it is always overwritten.
#
#  Step 4 — .pot merge
#    Combines rust.pot + python.pot + po/bash_notify.pot.in (static Bash
#    notification keys) into a single merged.pot via msgcat --use-first.
#
#  Step 5 — Header fixup
...
# ── 3. Update POTFILES.in automatically ──────────────────────────────────────
echo "[3/6] Updating POTFILES.in..."
{
...
echo "   → POTFILES.in updated with $((${#RUST_FILES[@]} + ${#PY_FILES[@]})) entries"

# ── 4. Merge all sources ──────────────────────────────────────────────────────
echo "[4/6] Merging extracted .pot files + static bash keys..."
MERGE=()
