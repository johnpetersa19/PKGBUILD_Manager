...
# ── 4. Extract Bash translation calls and update POTFILES.in ─────────────────
echo "[4/7] Extracting Bash translation strings and updating POTFILES.in..."
BASH_I18N="$ROOT/data/nautilus-scripts/_i18n"
BASH_INSTALL="$ROOT/pkgbuild-manager.install"
xgettext \
    --from-code=UTF-8 \
    --language=Shell \
    --keyword \
...
echo "   → POTFILES.in updated with $((${#RUST_FILES[@]} + ${#PY_FILES[@]} + ${#BLUEPRINT_FILES[@]} + ${#UI_FILES[@]} + 2)) entries"
