...
/* Log text — large enough to read comfortably */
.log-view text {
...
impl AurPushWindow {
    pub fn new(
        ...
        // Progress bar — right below the header, always visible during run
        ...
        // ──────────────────────────────────────────────────────────────
        // SECTION 1: Commit message + tag (always first)
        // ──────────────────────────────────────────────────────────────
        ...
        // ──────────────────────────────────────────────────────────────
        // SECTION 3: Full log (collapsible, hidden until there's content)
        // ──────────────────────────────────────────────────────────────
        ...
        // ──────────────────────────────────────────────────────────────
        // SECTION 4: Error box — shown only when errors occur
        // ──────────────────────────────────────────────────────────────
                ...
                while let Ok(msg) = receiver.recv().await {
                    match msg {
                        Msg::Log(line) => {
                            ...
                            // Show the log expander as soon as we have output
                            if !log_expander.is_visible() {
                                log_expander.set_visible(true);
                            }

                            // Mirror stderr lines into the error box
                        ...
                        Msg::Done(ok) => {
                            *running.borrow_mut() = false;
                            ...
                            if ok {
                                ...
                                // Error details already visible in error_box;
                                // expand the full log for debugging
